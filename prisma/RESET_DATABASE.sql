-- ============================================================================
-- COMPLETE DATABASE RESET - Drops everything and recreates from scratch
-- ============================================================================
-- ⚠️  WARNING: This will DELETE ALL existing data and tables! ⚠️
-- ============================================================================

-- Step 1: Drop all tables (CASCADE will drop dependencies) - in correct order
...
-- Step 2: Now drop enum types (tables are gone, so types can be dropped)
...
-- Step 3: Drop any other tables that might exist with different naming
DROP TABLE IF EXISTS contact_channel CASCADE;
DROP TABLE IF EXISTS organisation_location CASCADE;
...
-- Next steps:
-- 1. Run seed files in order: 001_regions.sql → 002_organisations.sql → 004_contacts.sql → 005_contact_channels.sql
-- 2. Run RBAC_SEED_DATA.sql for roles and permissions
-- 3. Run RBAC_RLS_POLICIES.sql for Row Level Security
-- ============================================================================
