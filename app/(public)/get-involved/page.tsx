...
export default function GetInvolvedPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
      {/* Header */}
      <ScrollReveal className="mb-12 relative">
        <GradientMesh
      ...
      <ScrollReveal className="mb-8">
        <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-sm border border-stone-200 dark:border-white/5 p-8 md:p-10">
          ...
          <div className="border-l-2 border-gold-500/20 pl-6 space-y-6">
            {standForItems.map((item, index) => (
              <ScrollReveal key={item.title} delay={index * 100}>
                <div className="w-2 h-2 bg-gold-500 rounded-full -ml-[1.35rem] mb-3" />
                <div className="flex items-start gap-4 p-4 rounded-2xl hover:bg-stone-50 dark:hover:bg-white/5 transition-colors">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            {joinUrl ? (
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gold-700 rounded-2xl font-bold hover:bg-stone-50 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                Join Us
                <ExternalLink size={18} />
              </a>
            ) : (
              <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/20 text-white rounded-2xl font-bold border border-white/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
